...
function getEmailTemplate(option, data) {
    ...
    switch (option) {
        case 1:
            format = {
                subject: 'Email Confirmation for AIO MART User Account.',
                body: '<html lang="en">' +
                    '<head>' +
                    ...
                    '<p style="margin:0;text-align:center;padding-left:20px;padding-right:20px">Cheers,<br>AIO MART Team</p>' +
                    '</td>' +
                    '</tr>' +
                    '</table>' +
                    '</td>' +
        ...
        case 2:
            format = {
                ...
                body: '<div style="margin:auto;text-align:center;left:50%;right:50%;float:none;border:0.5px;border-color:black;border-style: solid;width:50%;padding:20px;color:black;">' +
                    '<h1>AIO MART New User Password</h1>' +
