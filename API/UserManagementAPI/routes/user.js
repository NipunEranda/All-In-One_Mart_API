 ...
 *         joinedDate:
 *           type: string
 *           description: Joined date of the user
 *         email:
 *           type: string
 *           description: Email of the user
 *         password:
 ...
 *   post:
 *     summary: Register customer to the system
 *     tags: [User]
 *     requestBody:
 *       required: true
 *       content:
...
router.post('/supplierRegistration', async function(req, res) {
    userService.registerSupplier(req, res);
});
 ...
 *   post:
 *     summary: Register supplier to the system
 *     tags: [User]
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/SupplierRegistrationRequest'
 *     responses:
 *       200:
 *         description: Registered successful
 *         content:
 ...
 *         description: Some server error
 */
 router.post('/customerRegistration', async function(req, res) {
    userService.registerCustomer(req, res);
});
