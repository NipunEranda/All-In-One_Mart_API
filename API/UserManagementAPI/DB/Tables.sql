DROP DATABASE IF EXISTS `aiomart_um`;

CREATE DATABASE IF NOT EXISTS `aiomart_um` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `aiomart_um`;
